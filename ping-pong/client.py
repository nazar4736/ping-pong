...
# --- ЗОБРАЖЕННЯ ----
ball_image = image.load("images/ball.png")
ball_image = transform.scale(ball_image, (30, 30))

paddle_left_img = image.load("images/platform_Left.png")
paddle_left_img = transform.scale(paddle_left_img, (20, 100))

paddle_right_img = image.load("images/platform_Right.png")
paddle_right_img = transform.scale(paddle_right_img, (20, 100))

background_image = image.load("images/background.png")
# --- ЗВУКИ ---
mixer.init()
sound_wall_hit = mixer.Sound("sound/metal_hit.mp3")
sound_platform_hit = mixer.Sound("sound/hit.mp3")
...
while True:
    ...
    if game_state:
        ...
        waiting_text = font_main.render("Очікування гравця...", True, (255, 255, 255))
